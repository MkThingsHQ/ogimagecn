---
title: MCP
description: Learn how to use the shadcn MCP (Model Context Protocol) server with ogcn.
---

[MCP](https://modelcontextprotocol.io/) is an open protocol that standardizes how applications provide context to LLMs. The shadcn CLI can register an MCP server so your editor can discover registry components—including **ogcn** Open Graph image components.
...
With MCP enabled, you can ask your IDE to work with ogcn Open Graph image components. Example prompts:
